...
public class MooseAnimations {
	...
	public static final AnimationDefinition ATTACK = AnimationDefinition.Builder.withLength(1.25F)
		.addAnimation("neck", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.4583F, KeyframeAnimations.degreeVec(22.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			...
			new Keyframe(1.0833F, KeyframeAnimations.degreeVec(-27.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("right_front_leg", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.7917F, KeyframeAnimations.posVec(0.0F, -1.5F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.0833F, KeyframeAnimations.posVec(0.0F, -1.5F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.25F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("left_front_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition CHARGING_ATTACK = AnimationDefinition.Builder.withLength(2.0F).looping()
		.addAnimation("upper_body", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
		...
		.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.8333F, KeyframeAnimations.degreeVec(25.0F, 5.0F, -10.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.0833F, KeyframeAnimations.degreeVec(25.0F, -5.0F, 10.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.3333F, KeyframeAnimations.degreeVec(25.0F, 5.0F, -10.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.5833F, KeyframeAnimations.degreeVec(25.0F, -5.0F, 10.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("dewlap", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.8333F, KeyframeAnimations.degreeVec(0.0F, 5.0F, -4.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.0833F, KeyframeAnimations.degreeVec(0.0F, -5.0F, 4.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.3333F, KeyframeAnimations.degreeVec(0.0F, 5.0F, -4.0F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition UPPERCUT = AnimationDefinition.Builder.withLength(0.5F)
		...
		.addAnimation("neck", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.2917F, KeyframeAnimations.degreeVec(-27.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("neck", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, -2.0F, -2.0F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition STOMPING_OLD = AnimationDefinition.Builder.withLength(1.25F)
		.addAnimation("upper_body", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
