...
public record CaveRiverHollowDensityFunction(DensityFunction horizontalDistance, DensityFunction riverHeight, DensityFunction riverRadius, WatershedMap watershedMap) implements DensityFunction {
    public static final KeyDispatchDataCodec<CaveRiverHollowDensityFunction> CODEC = KeyDispatchDataCodec.of(
            MapCodec.unit(new CaveRiverHollowDensityFunction(DensityFunctions.constant(0), DensityFunctions.constant(0), DensityFunctions.constant(0), null))
    );
    ...
    public DensityFunction mapAll(Visitor visitor) {
        return visitor.apply(new CaveRiverHollowDensityFunction(this.horizontalDistance().mapAll(visitor), this.riverHeight().mapAll(visitor), this.riverRadius().mapAll(visitor), this.watershedMap()));
    }
