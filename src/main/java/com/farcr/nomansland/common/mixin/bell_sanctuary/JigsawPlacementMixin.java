...
import com.farcr.nomansland.CenteredSinglePoolElement;
...
public class JigsawPlacementMixin {
    ...
    private static BlockPos nml$includeOffset(BlockPos instance, Vec3i vector, Operation<BlockPos> original,
                                              @Local StructurePoolElement element, @Local StructureTemplateManager manager, @Local Rotation rotation) {
        if (element instanceof CenteredSinglePoolElement centeredPool) {
