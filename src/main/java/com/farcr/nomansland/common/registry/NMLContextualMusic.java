...
import com.farcr.nomansland.client.music.condition.AnachronisticMusicCondition;
...
public class NMLContextualMusic {
    ...
    public static final Supplier<AnachronisticMusicCondition> ANACHRONISTIC_CONTEXTUAL_MUSIC = CONTEXTUAL_MUSIC_REGISTRY.register("anachronistic_music", AnachronisticMusicCondition::new);
}
