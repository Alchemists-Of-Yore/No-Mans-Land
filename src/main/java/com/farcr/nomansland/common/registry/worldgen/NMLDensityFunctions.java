...
import com.farcr.nomansland.common.world.densityfunction.RemapDensityFunction;
...
public class NMLDensityFunctions {
    ...
    public static final Supplier<MapCodec<RemapDensityFunction>> REMAP =
            DENSITY_FUNCTIONS.register("remap", RemapDensityFunction.CODEC::codec);
}
