...
public class CreativeModeTabHandler {
    ...
    private void addBuildingBlocks(final BuildCreativeModeTabContentsEvent event) {
        insertAfter(CHISELED_TUFF_BRICKS, CHISELED_IVORY_LIMESTONE);
        insertAfter(CHISELED_TUFF_BRICKS, IVORY_LIMESTONE_BRICK_WALL);
        insertAfter(CHISELED_TUFF_BRICKS, IVORY_LIMESTONE_BRICK_SLAB);
        insertAfter(CHISELED_TUFF_BRICKS, IVORY_LIMESTONE_BRICK_STAIRS);
        insertAfter(CHISELED_TUFF_BRICKS, IVORY_LIMESTONE_BRICKS);
        insertAfter(CHISELED_TUFF_BRICKS, POLISHED_IVORY_LIMESTONE_SLAB);
        insertAfter(CHISELED_TUFF_BRICKS, POLISHED_IVORY_LIMESTONE_STAIRS);
        insertAfter(CHISELED_TUFF_BRICKS, POLISHED_IVORY_LIMESTONE);
        insertAfter(CHISELED_TUFF_BRICKS, IVORY_LIMESTONE_WALL);
        insertAfter(CHISELED_TUFF_BRICKS, IVORY_LIMESTONE_SLAB);
        insertAfter(CHISELED_TUFF_BRICKS, IVORY_LIMESTONE_STAIRS);
        insertAfter(CHISELED_TUFF_BRICKS, IVORY_LIMESTONE);
        insertAfter(CHISELED_TUFF_BRICKS, CHISELED_LIMESTONE);
        insertAfter(CHISELED_TUFF_BRICKS, LIMESTONE_BRICK_WALL);
        insertAfter(CHISELED_TUFF_BRICKS, LIMESTONE_BRICK_SLAB);
        insertAfter(CHISELED_TUFF_BRICKS, LIMESTONE_BRICK_STAIRS);
        insertAfter(CHISELED_TUFF_BRICKS, LIMESTONE_BRICKS);
        insertAfter(CHISELED_TUFF_BRICKS, POLISHED_LIMESTONE_SLAB);
        insertAfter(CHISELED_TUFF_BRICKS, POLISHED_LIMESTONE_STAIRS);
        insertAfter(CHISELED_TUFF_BRICKS, POLISHED_LIMESTONE);
        insertAfter(CHISELED_TUFF_BRICKS, LIMESTONE_WALL);
        insertAfter(CHISELED_TUFF_BRICKS, LIMESTONE_SLAB);
        insertAfter(CHISELED_TUFF_BRICKS, LIMESTONE_STAIRS);
        insertAfter(CHISELED_TUFF_BRICKS, LIMESTONE);
    ...
    private void addNaturalBlocks(final BuildCreativeModeTabContentsEvent event) {
        ...
        insertAfter(THERMAL_VENT.asItem(), SULFURIC_FUMAROLE);
