...
public class NMLBiomeTagsProvider extends BiomeTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        addToTags(NMLBiomes.MUD_BEACH, NMLTags.IS_SHORELINE, Tags.Biomes.IS_AQUATIC, Tags.Biomes.IS_RARE, Tags.Biomes.IS_WET);
        addToTags(NMLBiomes.GRAVEL_BEACH, NMLTags.IS_SHORELINE, Tags.Biomes.IS_COLD);
    }
