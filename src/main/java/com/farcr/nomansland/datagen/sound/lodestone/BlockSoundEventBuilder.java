...
public class BlockSoundEventBuilder {
    ...
    public static BlockSoundEventBuilder create(String path, DeferredSoundType soundType) {
        return new BlockSoundEventBuilder(path, soundType);
    }

    public BlockSoundEventBuilder(String path, DeferredSoundType soundType) {
        this(path, soundType::getBreakSound, soundType::getStepSound, soundType::getPlaceSound, soundType::getHitSound, soundType::getFallSound);
    }
