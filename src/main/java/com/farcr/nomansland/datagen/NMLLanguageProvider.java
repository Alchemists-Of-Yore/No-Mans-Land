...
public class NMLLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("item.nomansland.bandage.effect.luck", "Luck Bandage");
        add("item.nomansland.bandage.effect.night_vision", "Night Vision Bandage");
        add("item.nomansland.bandage.effect.oozing", "Oozing Bandage");
        add("item.nomansland.bandage.effect.poison", "Poison Bandage");
        add("item.nomansland.bandage.effect.regeneration", "Regeneration Bandage");
        add("item.nomansland.bandage.effect.slow_falling", "Slow Falling Bandage");
        add("item.nomansland.bandage.effect.slowness", "Slowness Bandage");
        add("item.nomansland.bandage.effect.strength", "Strength Bandage");
        add("item.nomansland.bandage.effect.speed", "Swiftness Bandage");
        add("item.nomansland.bandage.effect.water_breathing", "Water Breathing Bandage");
