...
public class NMLLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("nomansland.subtitles.entity.deer.shed_antlers", "Deer sheds it's antlers");
        add("nomansland.subtitles.entity.moose.death", "Moose dies");
        add("nomansland.subtitles.entity.moose.hurt", "Moose hurts");
        ...
        add("item.nomansland.bandage.effect.fire_resistance", "Bandage of Fire Resistance");
        add("item.nomansland.bandage.effect.harming", "Bandage of Harming");
        add("item.nomansland.bandage.effect.healing", "Bandage of Healing");
        add("item.nomansland.bandage.effect.infested", "Bandage of Infestation");
        add("item.nomansland.bandage.effect.invisibility", "Bandage of Invisibility");
        add("item.nomansland.bandage.effect.jump_boost", "Bandage of Leaping");
        add("item.nomansland.bandage.effect.luck", "Bandage of Luck");
        add("item.nomansland.bandage.effect.night_vision", "Bandage of Night Vision");
        add("item.nomansland.bandage.effect.oozing", "Bandage of Oozing");
        add("item.nomansland.bandage.effect.poison", "Bandage of Poison");
        add("item.nomansland.bandage.effect.regeneration", "Bandage of Regeneration");
        add("item.nomansland.bandage.effect.slow_falling", "Bandage of Slow Falling");
        add("item.nomansland.bandage.effect.slowness", "Bandage of Slowness");
        add("item.nomansland.bandage.effect.strength", "Bandage of Strength");
        add("item.nomansland.bandage.effect.speed", "Bandage of Swiftness");
        add("item.nomansland.bandage.effect.water_breathing", "Bandage of Water Breathing");
        add("item.nomansland.bandage.effect.weakness", "Bandage of Weakness");
        add("item.nomansland.bandage.effect.weaving", "Bandage of Weaving");
        add("item.nomansland.bandage.effect.wind_charged", "Bandage of Wind Charging");
